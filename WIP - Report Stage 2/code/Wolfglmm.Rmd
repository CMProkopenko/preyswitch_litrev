...
scattop2abund_more_PaperID <- ggplot(scattop2abund.more) +
  geom_point(aes(x = Ratio_Ind, y = Ratio_Occs, color = Paper_ID)) + 
   geom_smooth(
    aes(x = Ratio_Ind, y = Ratio_Occs, color = Paper_ID)
  ) +
  geom_abline(intercept = 0, slope = 1, linetype = "dashed") + 
  theme_classic() + 
  theme(text = element_text(size = 10)) +
...
scattop2abund_more_density_colourlog <- ggplot(scattop2abund.more.density) +
  geom_point(aes(x = Ratio_Ind, y = Ratio_Occs, color = Density)) + 
  geom_abline(intercept = 0, slope = 1, linetype = "dashed") + 
  theme_classic() + 
  theme(text = element_text(size = 10)) +
...
ggsave("~/Github/preyswitch_litrev/WIP - Report Stage 2/plots/scattop2abund_more_density_colourlog.png", plot = scattop2abund_more_density_colourlog, height = 5, width = 7, dpi = 700)

scattop2abund_more_density_colourlog




scattop2abund_more_densitytot <- ggplot(scattop2abund.more.density) +
  geom_point(aes(x = Ratio_Ind, y = Ratio_Occs, color = Density_Tot), size = 3) + 
  geom_abline(intercept = 0, slope = 1, linetype = "dashed") + 
  theme_classic() + 
...
ggsave("~/Github/preyswitch_litrev/WIP - Report Stage 2/plots/scattop2abund_more_densitytot.png", plot = scattop2abund_more_densitytot, height = 5, width = 7, dpi = 700)

scattop2abund_more_densitytot




scattop2abund_more_densitytot_colourlog <- ggplot(scattop2abund.more.density) +
  geom_point(aes(x = Ratio_Ind, y = Ratio_Occs, color = Density_Tot), size = 3) + 
  geom_abline(intercept = 0, slope = 1, linetype = "dashed") + 
  theme_classic() + 
  theme(text = element_text(size = 16)) +
...
ggsave("~/Github/preyswitch_litrev/WIP - Report Stage 2/plots/scattop2abund_more_densitytot_colourlog.png", plot = scattop2abund_more_densitytot_colourlog, height = 5, width = 7, dpi = 700)

scattop2abund_more_densitytot_colourlog
```
