...
```{r, Create a dataframe with the placemark (study area) name and centroid Lat and Long}
...
```{r, Use the centroids to make a map}
...
study_area <- st_read("~/Github/preyswitch_litrev/data/Study_Areas_By_Code.kml") 
...
## Save it as a csv
```{r}
write.csv(study_area_ecoregions, "~/Github/preyswitch_litrev/data/Study_Area_Ecoregions_Dataframe.csv", row.names = FALSE)
```
